...
export default function OfferCard({ offerData, sender }: OfferCardProps) {
  ...
  return (
    <motion.div
      ...
      className="max-w-sm"
    >
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/10 via-accent/5 to-primary/5 border border-primary/20 shadow-lg hover:shadow-xl transition-all duration-300 p-5">
        {/* Glow effect */}
          ...
          {sender === 'farmer' && !actionTaken && (
            <div className="flex gap-2 mt-4">
              <motion.button
                ...
                className="flex-1 px-4 py-3 rounded-lg bg-primary text-primary-foreground font-semibold text-sm hover:bg-primary/90 transition-all duration-300 shadow-md hover:shadow-lg"
              >
                Accept Offer
              </motion.button>
              <motion.button
                ...
                className="flex-1 px-4 py-3 rounded-lg border-2 border-primary text-primary font-semibold text-sm hover:bg-primary/5 transition-all duration-300"
              >
                Counter Offer
              </motion.button>
            </div>
          ...
          {actionTaken === 'counter' && (
            ...
            >
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg bg-background border border-border text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
              />
              <button className="w-full px-3 py-2 rounded-lg bg-primary text-primary-foreground text-sm font-semibold hover:bg-primary/90 transition-all duration-300">
                Send Counter Offer
              </button>
            </motion.div>
          )}
